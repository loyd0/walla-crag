...
const Footer = ({ logo, items }) => {
    return (
        <footer className="text-center text-base pt-12 bg-primary text-white max-w-5xl mx-auto">
            <div className="flex md:flex-row flex-col">
                <div className="flex flex-col w-full  justify-center my-12 md:my-0">
                ...
                <div className="flex flex-row w-full py-4">
                    <div className="w-full md:w-1/2 text-left px-16">
